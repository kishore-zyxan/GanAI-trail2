...
def insert_into_mysql(file_name, json_data, request_id, file_id, upload_date_time):
    conn = connect_mysql()
    cursor = conn.cursor()
    query = """
        INSERT INTO documents (file_name, json_data, request_id, file_id, upload_date_time)
        VALUES (%s, %s, %s, %s, %s)
    """
